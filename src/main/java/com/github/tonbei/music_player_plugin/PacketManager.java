 ...
 *  https://github.com/BadlionClient/BadlionClientModAPI/blob/1.2.3/LICENSE
 *
 *  Original Source : https://github.com/BadlionClient/BadlionClientModAPI/blob/1.2.3/blcmodapibukkit-1.17/src/main/java/net/badlion/blcmodapibukkit/listener/PlayerListener.java
 */
...
public class PacketManager {
    ...
    public PacketManager(MusicPlayerPlugin plugin) {
        this.plugin = plugin;
    ...
    public void sendPacket(Map<String, String> packetData, Player player) {
        String channel = MusicPlayerPlugin.CHANNEL;
        Object message = MusicPlayerPlugin.GSON.toJson(packetData).getBytes();
